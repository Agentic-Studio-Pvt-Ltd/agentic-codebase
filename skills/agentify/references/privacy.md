...
the one thing the no-network default gives up (`docs/DECISIONS.md` §3.2).
...
has not happened in this agent yet. PRD §5 calls this the secondary user and says the tool still
