# -*- coding: utf-8 -*-
"""
agentic-codebase :: scripts/lib

Shared, dependency-free helpers for the agentic-codebase analyzer scripts.
...
self-test):
    ...
    scrub     secret redaction + secret-filename detection.  Everything that
              ...
              passes through here FIRST.  CLAUDE.md, contract "Shared libs".
